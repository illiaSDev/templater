...
/*  $filepath = '"' . getcwd() . '\\newDir\\' . $obj[0] . '"';
  ...
  //echo $command;
  //exec($command);
//exec('C:\Program Files\WinRAR>rar a -ep1 -r e:\WordPress\OpenServer\modules\system\
//mpress.rar E:\WordPress\OpenServer\modules\system\html\openserver\test\newDir');
...
exec($command);
$command2 = 'zip -r ' . getcwd() . 'archive.zip "' . getcwd() . ' \\toZip"';
exec($command2);*/
/*$structure = 'newDir/Фінальні документи';
mkdir(mb_convert_encoding($structure, 'cp1251'), 0777, true);
chdir(mb_convert_encoding($structure, 'cp1251'));
